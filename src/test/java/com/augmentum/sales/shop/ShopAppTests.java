...
public class ShopAppTests {
	...
	public void verifyXpath() throws MalformedURLException, IOException, XPatherException{
	...
	public void verifyXpath2() throws MalformedURLException, IOException, XPatherException{
			 ...
			 nodes.forEach(item ->{
				 ...
				 keySet.forEach(key -> {
					 if(key.equalsIgnoreCase("href")) {
						 System.out.println("url " + (String)atts.get(key));
					 }
				 });
